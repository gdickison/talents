      ...
      <form action="submit" className='space-y-4'>
        ...
        <div>
          <label for="category" className="block text-sm font-medium leading-6">
            Select Category
            <div className="mt-2">
              <select rows={5} name="category" id="category" className="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 capitalize">
        ...
        <div>
          <label for="brand" className="block text-sm font-medium leading-6">
            Brand
            <div className="mt-2">
        ...
        <div>
          <label for="price" className="block text-sm font-medium leading-6">
            ...
            <div className="relative mt-2 rounded-md shadow-sm">
              ...
              <input type="text" name="price" id="price" className="block w-full rounded-md border-0 py-1.5 pl-7 pr-12 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="0.00" aria-describedby="price-currency"/>
        ...
        <div>
          <label for="sku" className="block text-sm font-medium leading-6">
            SKU
            <div className="mt-2">
        ...
        <div>
          <label for="weight" className="block text-sm font-medium leading-6">
            Shipping Weight
            <div className="mt-2">
        ...
        <div>
          <label for="height" className="block text-sm font-medium leading-6">
            Height
            <div className="mt-2">
        ...
        <div>
          <label for="width" className="block text-sm font-medium leading-6">
            Width
            <div className="mt-2">
        ...
        <div>
          <label for="depth" className="block text-sm font-medium leading-6">
            Depth / Length
            <div className="mt-2">
        ...
        <div>
          <label for="warrantyInformation" className="block text-sm font-medium leading-6">
        ...
        <div>
          <label for="shippingInformation" className="block text-sm font-medium leading-6">
        ...
        <div>
          <label for="returnPolicy" className="block text-sm font-medium leading-6">
            Return Policy
            <div className="mt-2">
          ...
          <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 bg-gray-100">
            <div className="text-center">
              ...
              <div className="mt-4 flex text-sm leading-6">
                <label for="qrCode" className="relative cursor-pointer rounded-md bg-gray-200 font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
                  <span className='px-2'>Upload a file</span>
                  <input id="qrCode" name="qrCode" type="file" className="sr-only"/>
                </label>
                <p className="pl-1 text-gray-500">or drag and drop</p>
              </div>
              <p className="text-xs leading-5 text-gray-500">PNG, JPG, WebP up to 250k</p>
            </div>
          </div>
        </div>
        <div className="block text-sm font-medium leading-6">
          ...
          <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 bg-gray-100">
            <div className="text-center">
              ...
              <div className="mt-4 flex text-sm leading-6">
                <label for="productImages" className="relative cursor-pointer rounded-md bg-gray-200 font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
                  <span className='px-2'>Upload multiple files</span>
                  <input id="productImages" name="productImages" type="file" className="sr-only"/>
                </label>
                <p className="pl-1 text-gray-500">or drag and drop</p>
              </div>
