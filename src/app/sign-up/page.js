      ...
      >
        <div className="mx-auto w-full max-w-sm">
          <div className="rb-6 mb-6 text-center md:mb-8 text-[#BF8B30]">
            <h1 className="mb-5 text-5xl font-marcellus md:mb-6 md:text-7xl lg:text-8xl">Sign Up</h1>
          </div>
          ...
          <div className="flex justify-between my-2 text-[#BF8B30]">
            <p className="text-[1rem] sm:text-[1.25rem]">Already have an account?</p>
            <Link href="/sign-in" className="underline text-[1rem] sm:text-[1.25rem]">Sign In</Link>
          </div>
        </div>
      </div>
    </section>
